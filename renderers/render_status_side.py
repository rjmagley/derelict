...
def render_status_side(root_console: Console, side_console: Console, player: Player):
    ...
    side_console.print(x = 0, y = 0, string = f"{player.delay}", fg = color.white)
    ...
    side_console.print(x = 0, y = 3, string = f"PSY: xxx/xxx", fg = color.white)
    ...
    if player.right_hand == None:
        ...
        side_console.print(x = 0, y = 7, string=player.right_hand.status_string, fg = color.white)
        side_console.print(x = 0, y = 8, string=player.right_hand.ammo_status, fg = color.white)
